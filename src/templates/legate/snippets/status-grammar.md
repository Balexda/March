...
| `error` (red) | Worker crashed or Claude entered an opaque failure state | Load `legate.error`, inspect/classify, and recover or escalate there. Do not blindly restart from babysit. |
