...
- `src/castra/`: Castra interactive-sessions host — the agent-deck adapter, the Fastify HTTP API over it, the shared-host container, and request telemetry. Owns the seam between consumers and `agent-deck`. See [`docs/Castra.md`](docs/Castra.md).
