...
| F6 | PR Integration                     | F5         | `specs/2026-05-24-006-pr-integration/`       |
...
| Milestone 3: Brood | depended upon by | Milestone 3 owns cleanup of the worktree, branch, and container lifecycle artifacts produced by Feature 2. Milestone 1 leaves stopped containers and worktrees in place for Feature 5 extraction; Brood (now the containerized teardown authority) later manages their disposal, removing by **exact tracked path, never `git worktree prune`** (#155). |
