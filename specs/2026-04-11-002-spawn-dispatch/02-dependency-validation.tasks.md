...
1. [ ] **Slice 1** — This is the only slice. Task 1 (deps.ts) should be implemented before Task 2 (cli.ts) because Task 2's integration tests exercise the function that Task 1 implements. Both tasks are in the same PR.
