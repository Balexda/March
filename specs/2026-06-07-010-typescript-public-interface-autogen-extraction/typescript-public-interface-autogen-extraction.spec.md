...
| US4 | Provide Deterministic Local Command Output | US1, US2, US3 | specs/2026-06-07-010-typescript-public-interface-autogen-extraction/04-provide-deterministic-local-command-output.tasks.md |
