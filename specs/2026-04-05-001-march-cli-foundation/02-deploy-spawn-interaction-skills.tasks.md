...
- [x] Run `npm test` and verify all tests pass, including the three per-skill title tests on lines 74–93 that assert placeholder content — those tests are correct for this milestone and must continue to pass.
